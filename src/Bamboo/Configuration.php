...
class Configuration
{
     ...
     * @var string
     */
    private static $_customImageHost = false;
    /**
    ...
    */
    ...
    public static function setCustomImageHost($imageHost) {
        self::$_customImageHost = $imageHost;
    }
    ...
    public static function getCustomImageHost() {
        return self::$_customImageHost;
    }
